...
<div class="container">
	<!-- ***INTRO BG*** -->
    <div class="d-flex align-items-center custom_soon-height">
		<div>
			<img class="img-fluid" src="<?php the_field( 'img_coming_soon' ); ?>" alt="<?php get_bloginfo( 'name' ); ?>">
			<div class="text-center mt-5 mb-5">
				<h2 class="cl--white text-3xl mb-3"><?php the_field( 'titulo' ); ?></h2>
				<h3 class="cl--white txt_font--second text-lg"><?php the_field( 'subtitulo' ); ?></h3>
			</div>
			<div class="list-social text-center">
				<ul class="mb-3">
					<li>
						<a class="btn-icon" href="<?php the_field( 'face_link' ); ?>" target="_blank">
							<!--FACE-->
							<svg fill="#efbb59" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								 width="30" height="30"
								 viewBox="0 0 30 30">
					...
					<li>
						<a class="btn-icon" href="<?php the_field( 'insta_link' ); ?>" target="_blank">
							<!--Instagram-->
							<svg fill="#efbb59" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								 width="30" height="30"
								 viewBox="0 0 30 30">
					...
					<li>
						<a class="btn-icon" href="<?php the_field( 'twitter_link' ); ?>" target="_blank">
							<!--twitter-->
							<svg fill="#efbb59" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
								 width="30" height="30"
								 viewBox="0 0 30 30">
				...
				<p class="cl--second">@soyesperanzagomez</p>
			</div>
		</div>
	</div>
</div>
