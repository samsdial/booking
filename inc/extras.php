...
if ( ! function_exists( 'understrap_post_nav' ) ) {
	...
	function understrap_post_nav() {
		...
		<nav class="container navigation post-navigation">
			...
			<div class="row nav-links   <?php
			if ( get_previous_post_link() ) {
				previous_post_link( ' justify-content-between', _x( '-', 'Previous post link', 'understrap' ) );
			}
			if ( get_next_post_link() ) {
				next_post_link( ' justify-content-end', _x( '-', 'Next post link', 'understrap' ) );
			}
			?> ">
				<?php
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous">%link</span>', _x( '<i class="txt_size--max fa fa-angle-left"></i> <p class="d-none">&nbsp;%title</p>', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next">%link</span>', _x( '<p class="d-none">%title&nbsp;</p> <i class="txt_size--max fa fa-angle-right"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
